...
Values(:category,:titlename,:package,:packageduratiobn,:Price,:uploadphoto,:description)";
    ...
    $query->bindParam(':uploadphoto', $uploadphoto, PDO::PARAM_STR);
          ...
          <div class="tile-body">
            <form class="row" method="post">
              ...
              <div class="form-group col-md-6">
                ...
                <input class="form-control" type="file" name="uploadphoto" id="uploadphoto">
              </div>
